...
Pass environment variables when deploying your agent using `kagenti-adk add --env KEY=VALUE` or via an env file with `--env-file .env`. See [Deploy Your Agent](../deploy-agents/deploy-your-agent) for details.
</Step>
