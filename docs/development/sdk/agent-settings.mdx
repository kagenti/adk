...
The Kagenti ADK platform provides a settings as a part of Form extension that creates an interactive UI component where users can configure these options before or during their interaction with your agent.

<Tip>
Settings extensions are a type of form [Service Extension](../sdk/overview#dependency-injection-service-extensions) that allows you to easily "inject dependencies" into your agent. This follows the inversion of control principle where your agent defines what it needs, and the platform provides those dependencies.
</Tip>
...
Import the necessary components from the Kagenti ADK form extension.
</Step>
...
**Import the form extension**: Import `FormServiceExtensionServer`, `FormServiceExtensionSpec`, `SettingsFormRender`, and field types from `kagenti_adk.a2a.extensions`.
...
Kagenti ADK supports various field types for collecting different kinds of configuration data:
...
```python
from kagenti_adk.a2a.extensions import CheckboxField, CheckboxGroupField
...
```python
from kagenti_adk.a2a.extensions import OptionItem, SingleSelectField
