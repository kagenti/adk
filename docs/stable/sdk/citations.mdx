---
title: Add Citations to Responses
...
Citations appear as highlighted text with hover tooltips and clickable source links in the Kagenti ADK UI,
...
Import `CitationExtensionServer` and `CitationExtensionSpec` from `kagenti_adk.a2a.extensions`.
</Step>
...
For a more advanced example, see [citation_agent.py](https://github.com/kagenti/adk/blob/main/apps/adk-py/examples/citation_agent.py).
