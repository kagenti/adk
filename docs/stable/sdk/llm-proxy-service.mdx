---
title: "LLM Proxy"
description: "Leverage Kagenti ADK's model and provider agnostic LLM inference"
---

When building AI agents, one of the first requirements is connecting to a Large Language Model (LLM). Kagenti ADK provides built-in, OpenAI-compatible LLM inference that is model and provider agnostic.
