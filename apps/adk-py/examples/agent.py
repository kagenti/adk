...
from kagenti_adk.a2a.extensions import LLMServiceExtensionServer
...
llm_extension_server = LLMServiceExtensionServer(
    spec=kagenti_adk.a2a.extensions.LLMServiceExtensionSpec(
        params=kagenti_adk.a2a.extensions.LLMServiceExtensionParams(
            llm_demands={
                "default": kagenti_adk.a2a.extensions.LLMDemand(
...
citation_extension_spec = kagenti_adk.a2a.extensions.CitationExtensionSpec()
trajectory_extension_spec = kagenti_adk.a2a.extensions.TrajectoryExtensionSpec()

embedding_service_extension_spec = kagenti_adk.a2a.extensions.EmbeddingServiceExtensionSpec(
    params=kagenti_adk.a2a.extensions.EmbeddingServiceExtensionParams(
        embedding_demands={
            "default": kagenti_adk.a2a.extensions.EmbeddingDemand(
...
class ChatAgentExecutor(a2a.server.agent_execution.AgentExecutor):
    def __init__(self):
        ...
        self.context_llm: dict[str, dict[str, kagenti_adk.a2a.extensions.LLMFulfillment]] = {}
