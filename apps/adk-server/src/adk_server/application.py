...
from adk_server.api.middleware.proxy_headers import ProxyHeadersMiddleware
from adk_server.api.middleware.rate_limit import RateLimitMiddleware
from adk_server.api.routes.a2a import router as a2a_router
from adk_server.api.routes.auth import well_known_router as auth_well_known_router
from adk_server.api.routes.configurations import router as configuration_router
from adk_server.api.routes.connectors import router as connectors_router
from adk_server.api.routes.contexts import router as contexts_router
from adk_server.api.routes.files import router as files_router
from adk_server.api.routes.model_providers import router as model_providers_router
from adk_server.api.routes.openai import router as openai_router
from adk_server.api.routes.providers import router as provider_router
from adk_server.api.routes.user import router as user_router
from adk_server.api.routes.user_feedback import router as user_feedback_router
from adk_server.api.routes.users import router as users_router
from adk_server.api.routes.variables import router as variables_router
from adk_server.api.routes.vector_stores import router as vector_stores_router
...
def get_version():
    try:
        __version__ = version("adk-server")
