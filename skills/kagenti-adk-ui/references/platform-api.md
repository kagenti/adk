...
See [`api.ts`](https://raw.githubusercontent.com/kagenti/adk/main/apps/adk-ts/examples/chat-ui/src/api.ts) for the reference implementation.
...
See [`api.ts`](https://raw.githubusercontent.com/kagenti/adk/main/apps/adk-ts/examples/chat-ui/src/api.ts) for the exact permission structure used in the reference example.
