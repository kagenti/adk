...
See [`client.ts`](https://raw.githubusercontent.com/kagenti/adk/main/apps/adk-ts/examples/chat-ui/src/client.ts) (`sendMessage` function) for the reference implementation of message sending and stream processing.
